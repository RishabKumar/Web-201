...
"use strict";
eval("\n\nvar _UIController = __webpack_require__(/*! ./UIController.js */ \"./src/scripts/controller/UIController.js\");\n\nvar ui = new _UIController.UIController('home');\nui.init();\n\n//# sourceURL=webpack:///./src/scripts/controller/GlobalController.js?");

/***/ }),

/***/ "./src/scripts/controller/UIController.js":
/*!************************************************!*\
  !*** ./src/scripts/controller/UIController.js ***!
  \************************************************/
/*! no static exports found */
...
/***/ "./src/scripts/home/components/header.js":
/*!***********************************************!*\
  !*** ./src/scripts/home/components/header.js ***!
  \***********************************************/
/*! no static exports found */
...
"use strict";
eval("\n\nObject.defineProperty(exports, \"__esModule\", {\n    value: true\n});\nexports.lazyBind = undefined;\n\nvar _common = __webpack_require__(/*! ../../common/common.js */ \"./src/scripts/common/common.js\");\n\nvar lazyBind = exports.lazyBind = function lazyBind(ele) {\n\n    var bufferheight = window.innerHeight;\n\n    var winstart = window.scrollY; //+ bufferheight;\n    var winend = winstart + bufferheight;\n    var elestart = ele.offsetTop;\n    var eleend = ele.offsetHeight > 0 ? ele.offsetTop + ele.offsetHeight : ele.offsetTop + 150;\n    var rect = ele.getBoundingClientRect();\n\n    if (ele.attributes['img-loaded'].value === 'false' && (rect.top < window.innerHeight && rect.top > 0 || rect.bottom > 0 && rect.bottom < window.innerHeight)) {\n        setTimeout(function () {\n            ele.attributes['src'].value = ele.attributes['lazy-img-src'].value;\n        }, 700);\n    }\n};\n\n//# sourceURL=webpack:///./src/scripts/home/components/lazy-load.js?");
...
"use strict";
eval("\n\nObject.defineProperty(exports, \"__esModule\", {\n    value: true\n});\n\nfunction _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError(\"Cannot call a class as a function\"); } }\n\nvar MenuItem = exports.MenuItem = function MenuItem(id, name, price, description, imgsrc, categoryid, tags) {\n    _classCallCheck(this, MenuItem);\n\n    this.id = id;\n    this.name = name;\n    this.price = price;\n    this.description = description;\n    this.imgsrc = imgsrc;\n    this.categoryid = categoryid;\n    this.tags = tags;\n};\n\n//# sourceURL=webpack:///./src/scripts/home/models/MenuItem.js?");
