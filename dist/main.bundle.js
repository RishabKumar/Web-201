...
"use strict";
eval("\n\nObject.defineProperty(exports, \"__esModule\", {\n  value: true\n});\nvar categoryTemplate = exports.categoryTemplate = function categoryTemplate(cat) {\n  return \"<li id=\\\"cat-\" + escape(cat.name) + \"\\\"><a href='#\" + escape(cat.name) + \"-placeholder'><img class='category-logo' src='\" + cat.imgsrc + \"' width='50px'><span>\" + cat.name + \"</span></a></li>\";\n};\n\n//# sourceURL=webpack:///./src/scripts/home/templates/category.js?");
